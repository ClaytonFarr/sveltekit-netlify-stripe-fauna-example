...
<template lang="pug">
  div(class='{containerClasses}').fixed.inset-0.z-50.flex.flex-col.pt-3.pb-4.pointer-events-none
      ...
      div(
        ...
        class='flex items-stretch rounded mb-2 text-white bg-gray-700 shadow-md pointer-events-auto {notification.type}'
          ...
          +if('notification.dismissable')
            button(on:click!="{() => notifications.dismiss(notification.id)}").text-gray-400.hover_text-white.px-4.focus_outline-none
